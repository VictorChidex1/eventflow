        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900">5,900+</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900">670K+</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900">550+</h3>
